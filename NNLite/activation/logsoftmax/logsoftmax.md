...
$$\frac{\partial E}{\partial Z_{ik}}\frac{\partial Z_{ik}}{\partial X_{ij}} = \begin{cases} {\frac{\partial E}{\partial Z_{ij}}}(1-\frac{e^{X_{ij}}}{\sum_{k=1}^m{e^{X_{ik}}}}) & \text{if k=j} \end{cases}$$
